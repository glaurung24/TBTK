...
// 	EXPECT_EQ(result.to_ulong(), 0x0000FFF0);
// }
...
// 	BitRegister result = bitRegister0 & bitRegister1;
// 	EXPECT_EQ(result.to_ulong(), 0x0000F000);
// }
...
// 	BitRegister result = bitRegister0 ^ bitRegister1;
// 	EXPECT_EQ(result.to_ulong(), 0x00000FF0);
// }
...
// 	BitRegister result = bitRegister0 + bitRegister1;
// 	EXPECT_EQ(result.to_ulong(), 0x12345678 + 0xABCD1234);
// }
...
// 	BitRegister result = bitRegister0 - bitRegister1;
// 	EXPECT_EQ(result.to_ulong(), 0xABCD1234 - 0x12345678);
// }
...
// 	EXPECT_EQ(bitRegister0.to_ulong(), 0x12345678 + 0xABCD1234);
// }
...
TEST(BitRegister, operatorAssignmentUnsignedInt1){
	BitRegister bitRegister;
	bitRegister = 0xFF00FF00;
	EXPECT_EQ(bitRegister.to_ulong(), 0xFF00FF00);
}
...
// 	EXPECT_EQ(result.to_ulong(), 0xFF00FF00 << 2);
// 	EXPECT_EQ(bitRegister.to_ulong(), 0xFF00FF00);
// }
...
// 	EXPECT_EQ(bitRegister.to_ulong(), 0xFFEF0020);
// }
...
// 	EXPECT_EQ(bitRegister.to_ulong(), 0xFFFF0000);
// }
...
// 	bitRegister.setValues(0xFFFF0000);
// 	bitRegister.clear();
// 	EXPECT_EQ(bitRegister.to_ulong(), 0x00000000);
// }
...
TEST(BitRegister, getNumBits1){
	BitRegister bitRegister;
	EXPECT_EQ(bitRegister.size(), 8*sizeof(unsigned int));
}
